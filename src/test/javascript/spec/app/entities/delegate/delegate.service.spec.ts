...
describe('Service Tests', () => {
  describe('Delegate Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(DelegateService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Delegate('ID', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Delegate', () => {
        ...
        service.create(new Delegate()).subscribe(resp => (expectedResult = resp.body));
